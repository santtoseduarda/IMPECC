...
public class ListagemFuncionarios extends JFrame {
	...
	public ListagemFuncionarios() {
		...
		lblCarrinho.setIcon(new ImageIcon(new ImageIcon("src/img/carrinho.png").getImage().getScaledInstance(40, 40, Image.SCALE_DEFAULT)));
		...
		panel.add(scrollPane, "cell 1 3 13 24,grow");
