...
public class TelaInicial extends JFrame {
	...
	public TelaInicial() {
		...
		lblLinha1.setIcon(new ImageIcon(new ImageIcon("src/img/Line7.png").getImage().getScaledInstance(500, 1, Image.SCALE_DEFAULT)));
		contentPane.add(lblLinha1, "cell 1 2 2 1");
		
		JLabel lblCarrinho = new JLabel("");
		lblCarrinho.setIcon(new ImageIcon(new ImageIcon("src/img/carrinho.png").getImage().getScaledInstance(55,55, Image.SCALE_DEFAULT)));
		...
		lblLinha2.setIcon(new ImageIcon(new ImageIcon("src/img/Line7.png").getImage().getScaledInstance(500, 1, Image.SCALE_DEFAULT)));
		contentPane.add(lblLinha2, "cell 1 4 2 1");
		
		JLabel lblCaixa = new JLabel("");
		lblCaixa.setIcon(new ImageIcon(new ImageIcon("src/img/caixa.png").getImage().getScaledInstance(55, 55, Image.SCALE_DEFAULT)));
		...
		lblProdutos.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
			//tela inicial para abrir em produtos
			}
		});
		...
		lblLinha3.setIcon(new ImageIcon(new ImageIcon("src/img/Line7.png").getImage().getScaledInstance(500, 1, Image.SCALE_DEFAULT)));
		contentPane.add(lblLinha3, "cell 1 6 2 1");
		
		JLabel lblClientes = new JLabel(" ");
		lblClientes.setIcon(new ImageIcon(new ImageIcon("src/img/cliente.png").getImage().getScaledInstance(55, 55, Image.SCALE_DEFAULT)));
		...
		lblLinha4.setIcon(new ImageIcon(new ImageIcon("src/img/Line7.png").getImage().getScaledInstance(500, 1, Image.SCALE_DEFAULT)));
		contentPane.add(lblLinha4, "cell 1 8 2 1");
		
		JLabel lblCaminhao = new JLabel("");
		lblCaminhao.setIcon(new ImageIcon(new ImageIcon("src/img/caminhao.png").getImage().getScaledInstance(60, 55, Image.SCALE_DEFAULT)));
		...
		lblLinha5.setIcon(new ImageIcon(new ImageIcon("src/img/Line7.png").getImage().getScaledInstance(500, 1, Image.SCALE_DEFAULT)));
		...
		lblLinha6.setIcon(new ImageIcon(new ImageIcon("src/img/Line7.png").getImage().getScaledInstance(500, 1, Image.SCALE_DEFAULT)));
