...
public class TelaLogin extends JFrame {
	...
	public TelaLogin() {
		...
		contentPane.add(panel, "cell 4 4 1 9,grow");
		...
		panel.add(lblNewLabel, "cell 1 1,alignx center");
		...
		panel.add(textField_1, "cell 1 6,growx");
		textField_1.setColumns(10);
		
		JLabel lblNewLabel_3 = new JLabel("Esqueceu sua senha?");
		lblNewLabel_3.setFont(new Font("Tahoma", Font.PLAIN, 9));
		panel.add(lblNewLabel_3, "cell 1 7,alignx left");
		panel.add(btnNewButton, "cell 1 9,alignx center");
		
		JButton btnNewButton_1 = new JButton("Cadastre-se");
		btnNewButton_1.setFont(new Font("Tahoma", Font.PLAIN, 14));
		panel.add(btnNewButton_1, "cell 1 11,alignx center");
	}
}